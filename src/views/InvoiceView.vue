<template>
  <div class="container invoice-view">
    <router-link class="flex nav-link" :to="{ name: 'Home' }">
    ...
    <div class="flex invoice-details flex-column">
      ...
      <div class="flex middle">
        <div class="flex payment flex-column">
          <h4>Invoice Date</h4>
          <p>
        ...
        <div class="flex bill flex-column">
          <h4>Bill To</h4>
        ...
        <div class="flex send-to flex-column">
          <h4>Sent To</h4>
          <p>{{ currentInvoice.clientEmail }}</p>
        </div>
      </div>
      <div class="flex bottom flex-column">
...
export default {
  ...
  created() {
    ...
    console.log("test", this.currentInvoice);
  },
  methods: {
    ...mapMutations([
      "SET_CURRENT_INVOICE",
